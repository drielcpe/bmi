...
class BMICalculator(tk.Tk):
    ...
    def show_weight_gathering(self, parameter):
        ...
        weight = 70  # Use the calculated average weight
    ...
    def show_temp_gathering(self):
        ...
        temp_label = tk.Label(self, text="{:.2f} °C".format(newtargetTemp), font=("Arial", 50, "bold"), padx=50, pady=15, bg="#1DB954", fg="black")
