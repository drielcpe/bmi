...
class BMICalculator(tk.Tk):
    ...
    def show_start_screen(self):
        ...
        self.clear_window()
        self.window_init() 
        video_path = self.relative_to_assets("start7.mp4")  
        if video_path.exists():
            self.cap = cv2.VideoCapture(str(video_path))
            self.video_label = tk.Label(self, bd=0, relief="flat")  
            self.video_label.place(x=55, y=70, bordermode="outside")
            self.updates_video()
        else:
        ...
        btn = ButtonConfig()
        my_label = tk.Label()
        my_label.pack(padx=4, pady=45)
        btn.create_button(20, 2, self, 640, 650, "START", "#1DB954", "#191414", self.show_intro_screen)

    def show_intro_screen(self):
        self.clear_window()
        self.window_init()
        video_path = self.relative_to_assets("start8.mp4")  
        if video_path.exists():
            self.cap = cv2.VideoCapture(str(video_path))
            self.video_label = tk.Label(self, bd=0, relief="flat")  
            self.video_label.place(x=55, y=70, bordermode="outside")
    ...
    def show_selection_screen(self):
        ...
        btn = ButtonConfig()
        btn.create_button(20,2,self,640, 500, "WEIGHT", "#1DB954", "#191414", lambda : self.show_weight_intro(1))
        btn.create_button(20,2,self,640, 350, "HEIGHT", "#1DB954", "#191414", lambda : self.show_height_intro(1))
        btn.create_button(20,2,self,640, 200, "BMI", "#1DB954", "#191414", self.show_bmi_screen)
        btn.create_button(20,2,self,640, 650, "TEMPERATURE", "#1DB954", "#191414", self.show_temperature_intro)
    ...
    def show_bmi_screen(self):
        ...
        btn.create_button(5, 2, self, btn_x, btn_y + 94, "4", "#1DB954", "#191414", lambda: self.number_pressed(4))
        btn.create_button(5, 2, self, btn_x, btn_y + 188, "1", "#1DB954", "#191414", lambda: self.number_pressed(1))
        btn.create_button(5, 2, self, btn_x + 104, btn_y + 188, "2", "#1DB954", "#191414", lambda: self.number_pressed(2))
        btn.create_button(5, 2, self, btn_x + 104, btn_y + 94, "5", "#1DB954", "#191414", lambda: self.number_pressed(5))
        btn.create_button(5, 2, self, btn_x + 104, btn_y, "8", "#1DB954", "#191414", lambda: self.number_pressed(8))
        btn.create_button(5, 2, self, btn_x + 208, btn_y + 188, "3", "#1DB954", "#191414", lambda: self.number_pressed(3))
        btn.create_button(5, 2, self, btn_x + 208, btn_y + 94, "6", "#1DB954", "#191414", lambda: self.number_pressed(6))
        btn.create_button(5, 2, self, btn_x + 208, btn_y, "9", "#1DB954", "#191414", lambda: self.number_pressed(9))
        btn.create_button(5, 2, self, btn_x + 312, btn_y, "0", "#1DB954", "#191414", lambda: self.number_pressed(0))
        btn.create_button(5, 5, self, btn_x + 312, btn_y + 140, "C", "#1DB954", "#191414", self.clear_entry)
        btn.create_button(10, 2, self, btn_x + 565, btn_y + 382, "NEXT", "#1DB954", "#191414",self.save_age)
        btn.create_button(5, 5, self, btn_x + 612, btn_y + 100, "MALE", "#1DB954", "#191414", lambda: self.select_gender('male'))
        btn.create_button(5, 5, self, btn_x + 512, btn_y + 100, "FEMALE", "#1DB954", "#191414", lambda: self.select_gender('female'))
    ...
    def show_height_gathering(self,parameter):
        ...
        self.gathering_label.pack(pady=350)
    ...
    def show_weight_display(self,parameter,weight):
        ...
        weight_label.place(x=640, y=380, anchor="center") 

        if parameter == 1:
            self.after(5000, lambda: self.show_start_screen())
        else:
            btn = ButtonConfig()
            btn.create_button(20, 2, self, 640, 670, "Next", "#1DB954", "#191414", self.show_bmi_calculating)
    ...
    def show_bmi_calculating(self):
        ...
        if video_path.exists():
            ...
            print(f"Error: {video_path} not found")
        video_duration = int(self.cap.get(cv2.CAP_PROP_FRAME_COUNT) / self.cap.get(cv2.CAP_PROP_FPS))
        self.after(video_duration * 700, self.show_bmi_calculation)

    def show_bmi_calculation(self):
        self.clear_window()
        self.window_init()

        _label = tk.Label(self, text=f"BMI = {self.weight}kg / ({self.height}m)²", font=("Arial", 50, "bold"), padx=50,pady=15, bg="#1DB954", fg="black")
        _label.place(x=640, y=380, anchor="center") 
    ...
    def show_bmi_result(self):
        ...
        _label.place(x=640, y=380, anchor="center") 
        _label_result = tk.Label(self, text=f"{bmi_result}", font=("Arial", 50, "bold"), padx=50, pady=15, bg="#1DB954", fg="black")
        _label_result.place(x=640, y=580, anchor="center")
    ...
    def show_height_display(self,parameter,height):
        ...
        height_label.place(x=640, y=380, anchor="center") 
        self.height = f"{height:.2f}"
        if parameter == 1:
            self.after(5000, lambda: self.show_start_screen())
        else:
            btn = ButtonConfig()
            btn.create_button(20, 2, self, 640, 670, "Next", "#1DB954", "#191414", lambda: self.show_weight_intro(parameter))
